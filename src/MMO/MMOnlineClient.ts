...
export class MMOnlineClient {
    ...
    autosaveSceneData() {
        if (!this.core.helper.isLinkEnteringLoadingZone() &&
            ...
            this.ModLoader.clientSide.sendPacket(new MMO_ClientSceneContextUpdate(live_scene_chests, live_scene_switches, live_scene_collect, live_scene_clear, live_scene_temp, this.ModLoader.clientLobby, this.core.global.scene));
        }
    }
    ...
    onSaveLoaded(evt: any) {
        setTimeout(() => {
            ...
            let gui_p: MMO_SceneGUIPacket = new MMO_SceneGUIPacket(this.core.global.scene, this.core.save.age, this.ModLoader.clientLobby);

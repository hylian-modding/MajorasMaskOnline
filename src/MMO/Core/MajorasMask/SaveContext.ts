...
import { ISaveContext, ISwords, IShields, IQuestStatus, Magic, IKeyManager } from "./API/MMAPI";
import { Inventory } from './Inventory';
import IMemory from "modloader64_api/IMemory";
import { IDungeonItemManager } from "./API/IDungeonItemManager";
...
export class SaveContext extends JSONTemplate implements ISaveContext {
    ...
    offsets: MMOffsets = new MMOffsets();
    inventory: Inventory;

...
if (!fse.existsSync(path.resolve("./dist/MM_christmas2020.content"))) {
    ...
    fse.writeFileSync(path.resolve("./dist/MM_christmas2020.content"), Buffer.from(content));
}